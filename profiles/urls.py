...
urlpatterns = [
    ...
    path('wishlists/delete<int:wishlist_id>', views.delete_wishlist, name='delete_wishlist'),
    ...
    path('wishlist/remove/<int:wishlist_id>/<int:product_id>/', views.remove_from_wishlist, name='remove_from_wishlist'),
]