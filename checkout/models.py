...
class Order(models.Model):
    ...
    def _generate_order_number(self):
        """ Generate a unique order number for every purchases made. """
    ...
    def save(self, *args, **kwargs):
        """
        Override the defualt save method, so the order number is set if it 
        hasn't been already.
        """
...
class OrderLineItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
        Override the defualt save method, to set the lineitem total and update the
        order total.
        """
